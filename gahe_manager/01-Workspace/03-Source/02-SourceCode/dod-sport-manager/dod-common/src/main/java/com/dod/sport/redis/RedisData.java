...
public class RedisData {
    ...
    public static UserRole getRedisRoleInfo(String roleCode){
        JSONObject data = JSONObject.fromObject(redisRepository.get(String.format(RedisConstants.SYSTEM_ROLE,roleCode)));
