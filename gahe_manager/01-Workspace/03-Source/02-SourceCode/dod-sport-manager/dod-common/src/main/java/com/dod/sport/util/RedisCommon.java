...
public class RedisCommon {
     ...
     * @return string
     */
    public static String createIdentifyingCode(String phoneNum,String operationId){
        String keyStr = String.format(RedisConstants.IDENTIFYING_CODE, phoneNum ,SysConfigConstants.PLATFORM_ID,
                operationId);
     ...
     * @return
     */
    public static boolean verifyIdentCode(String phoneNum,String identCode,String operationId){
        boolean result = false;
        if (!redisRepository.exists(String.format(RedisConstants.IDENTIFYING_CODE,phoneNum,SysConfigConstants.PLATFORM_ID,
                operationId))){
            return result;
        }
        String validIdentCode = (String)redisRepository.get(String.format(RedisConstants.IDENTIFYING_CODE,phoneNum,
                SysConfigConstants.PLATFORM_ID,operationId));
    ...
    public static String getMaxEmployeeId(String businessId){
        ...
        if (redisRepository.exists(String.format(RedisConstants.EMPLOYEE_ID,businessId))){
            ...
            maxId = StringUtil.getMaxBillId(maxId, SysConfigConstants.EMPLOYEE_SERIAL_LENGTH);
    ...
    public static String setAndReturnMaxEmployeeId(String businessId, String nowId){
        //刷新最新流水号
        String maxId = StringUtil.getMaxBillId(nowId, SysConfigConstants.EMPLOYEE_SERIAL_LENGTH);
        redisRepository.set(String.format(RedisConstants.EMPLOYEE_ID,businessId),maxId);
        return maxId;
    }
    ...
    public static String getMaxMemberId(String businessId){
        ...
        if (redisRepository.exists(String.format(RedisConstants.MEMBER_ID,businessId))){
            ...
            maxId = StringUtil.getMaxBillId(maxId, SysConfigConstants.MEMBER_SERIAL_LENGTH);
    ...
    public static String setAndReturnMaxMemberId(String businessId, String nowId){
        //刷新最新流水号
        String maxId = StringUtil.getMaxBillId(nowId, SysConfigConstants.MEMBER_SERIAL_LENGTH);
        redisRepository.set(String.format(RedisConstants.MEMBER_ID,businessId),maxId);
        return maxId;
    }
     ...
     * @return
     */
    public static String setAndReturnMaxMemberCardId(String businessId, String nowId){
        //刷新最新流水号
     ...
     * @return
     */
    public static String getMaxMemberCardTypeId(){
        String maxId = "";
        //获取最新流水号
        if (redisRepository.exists(String.format(RedisConstants.MEMBERCARDTYPE_ID))){
            maxId = (String)redisRepository.get(String.format(RedisConstants.MEMBERCARDTYPE_ID));
            maxId = StringUtil.getMaxBillId(maxId, SysConfigConstants.MEMBERCARDTYPE_SERIAL_LENGTH);
            redisRepository.set(String.format(RedisConstants.MEMBERCARDTYPE_ID),maxId);
        }
        String result = maxId;
        return result;
    }
     ...
     * @return
     */
    public static String setAndReturnMaxMemberCardTypeId(String nowId){
        //刷新最新流水号
        String maxId = StringUtil.getMaxBillId(nowId, SysConfigConstants.MEMBERCARDTYPE_SERIAL_LENGTH);
        redisRepository.set(String.format(RedisConstants.MEMBERCARDTYPE_ID),maxId);
        return maxId;
    }
     ...
     * @return
     */
    public static String getMaxClassroomId(){
        String maxId = "";
        //获取最新流水号
        if (redisRepository.exists(String.format(RedisConstants.CLASSROOM_ID))){
            maxId = (String)redisRepository.get(String.format(RedisConstants.CLASSROOM_ID));
            maxId = StringUtil.getMaxBillId(maxId, SysConfigConstants.COMMON_SERIAL_LENGTH_3);
            redisRepository.set(String.format(RedisConstants.CLASSROOM_ID),maxId);
        }
        String result = maxId;
        return result;
    }
     ...
     * @return
     */
    public static String setAndReturnMaxClassroomId(String nowId){
        //刷新最新流水号
        String maxId = StringUtil.getMaxBillId(nowId, SysConfigConstants.COMMON_SERIAL_LENGTH_3);
        redisRepository.set(String.format(RedisConstants.CLASSROOM_ID),maxId);
        return maxId;
     ...
     * @return
     */
    public static String getMaxRegisterId(){
        String maxId = "";
        //获取最新流水号
        if (redisRepository.exists(RedisConstants.EMPLOYEE_ID)){
            maxId = (String)redisRepository.get(String.format(RedisConstants.EMPLOYEE_REGISTER_ID));
            maxId = StringUtil.getMaxBillId(maxId,SysConfigConstants.COMMON_SERIAL_LENGTH_6);
            redisRepository.set(String.format(RedisConstants.EMPLOYEE_REGISTER_ID),maxId);
        }
        String result = maxId;
        return result;
    }
     ...
     * @return
     */
    public static String setAndReturnMaxRegisterId(String nowId){
        //刷新最新流水号
    ...
    public static String getMaxFunctionDetailId(String platformId){
        ...
        if (redisRepository.exists(String.format(RedisConstants.FUNCTION_DETAIL_ID,platformId))){
            ...
            maxId = StringUtil.getMaxBillId(maxId, SysConfigConstants.COMMON_SERIAL_LENGTH_4);
    ...
    public static String setAndReturnMaxFunctionDetailId(String platformId, String nowId){
        //刷新最新流水号
        String maxId = StringUtil.getMaxBillId(nowId, SysConfigConstants.COMMON_SERIAL_LENGTH_4);
        redisRepository.set(String.format(RedisConstants.FUNCTION_DETAIL_ID, platformId),maxId);
        return maxId;
    }
     ...
     * @return
     */
    public static String getMaxManagerUseSerialId(){
        String maxId = "";
        if (redisRepository.exists(RedisConstants.MANAGER_USER_ID)){
            maxId = (String)redisRepository.get(RedisConstants.MANAGER_USER_ID);
            maxId = StringUtil.getMaxBillId(maxId, SysConfigConstants.EMPLOYEE_SERIAL_LENGTH);
            redisRepository.set(RedisConstants.MANAGER_USER_ID,maxId);
        }
        String result = maxId;
        return result;
    }
     ...
     * @return
     */
    public static String setAndReturnMaxManagerUserSerialId(String nowId){
        String maxId = StringUtil.getMaxBillId(nowId, SysConfigConstants.EMPLOYEE_SERIAL_LENGTH);
        redisRepository.set(RedisConstants.MANAGER_USER_ID,maxId);
        return maxId;
    }
    ...
    public static String getMaxClientUserId(){
        ...
        String maxId = "";
        if (redisRepository.exists(RedisConstants.CLIENTUSER_ID)){
            maxId = (String)redisRepository.get(RedisConstants.CLIENTUSER_ID);
            maxId = StringUtil.getMaxBillId(maxId,SysConfigConstants.COMMON_SERIAL_LENGTH_9);
            redisRepository.set(RedisConstants.CLIENTUSER_ID,maxId);
        }
        String result = maxId;
        return result;
