...
public class CardPopupWindow extends PopupWindow{
     ...
     * @param strings   内容数组
     */
    public CardPopupWindow(Activity context, View.OnClickListener itemsOnClick, String... strings) {
        super(context);
        this.mContext =  context;
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mMenuView = inflater.inflate(R.layout.popupwindow_card, null);
