...
public class MultiLineRadioGroup extends ViewGroup implements OnClickListener {
    ...
    private String[] type = {"事假","病假","丧假","婚假","产假","护理假","休假","其他"};
    private int vid=0;
    Context context;
    private  AskForLeaveTypeEvent mAFLTEvent = new AskForLeaveTypeEvent();
    ...
    public void onClick (View v) {
        try {
            ...
            int id = (Integer) v.getTag();
                ...
                if (id!=0){
                    viewList.get(0).setChecked(false);
                }
            ...
            //Log.i("*****", "onClick:点击 ----》"+id+"\t");
            mAFLTEvent.setMsg(childValues.get(id)+"" );
            mAFLTEvent.setmPosition(id);
            mAFLTEvent.setType("ask");
            EventBus.getDefault().post(mAFLTEvent);
