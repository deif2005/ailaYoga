...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int indicatorColor = getContext().getResources().getColor(R.color.home_text_selected);
    ...
    private int tabTextColor = getResources().getColor(R.color.ash);
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabsContainer.setBackgroundColor(Color.TRANSPARENT);        //tab背景颜色
