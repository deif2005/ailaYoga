...
//        wiFiMACBean.setLongitude(longitudes);
    ...
    *//**
     ...
     *
     * */
    public static void setUserDataBean(Context context,UserBean datas){

        SharedPreferences.Editor editor = context.getSharedPreferences("userdata", Context.MODE_PRIVATE).edit();
        UserBean.DatasBean.LoginClientUserInfoBean userDataBean = datas.getDatas().getLoginClientUserInfo();
...
//        editor.putString("workDuration",userDataBean.getWorkDuration());
    ...
    /**工作台（个人资料）*/
    public static UserBean.DatasBean.LoginClientUserInfoBean getUserDataBean(Context context){
        ...
        UserBean.DatasBean.LoginClientUserInfoBean userDataBean = new UserBean.DatasBean.LoginClientUserInfoBean();
//
//
