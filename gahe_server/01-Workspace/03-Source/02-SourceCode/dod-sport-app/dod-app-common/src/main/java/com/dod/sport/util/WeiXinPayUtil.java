...
public class WeiXinPayUtil {
	...
	public static String getTradeNo() {
		// 自增8位数 00000001
		return "TNO" + DateUtil.formatDate( "yyyyMMddHHmmssSSS",new Date()) + "00000001";
	}
	...
	public static String getRefundNo() {
		// 自增8位数 00000001
		return "RNO" + DateUtil.formatDate( "yyyyMMddHHmmssSSS",new Date()) + "00000001";
	}
