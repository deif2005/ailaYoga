...
public class Jpush {
    ...
    public static String getMasterSecret() {
        if (type==1){
            masterSecret = Configuration.getJgPushMasterSecret();
        }else if (type==2){
            masterSecret =Configuration.getClientJgPushMasterSecret();
        }
        return masterSecret;
    }
    public static String getAppKey() {
        if (type==1){
            appKey = Configuration.getJgPushAppkey();
        }else if (type==2){
            appKey = Configuration.getClientJgPushAppkey();
        }
        return appKey;
    }
